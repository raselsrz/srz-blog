                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-bold mb-0"><?php echo  db()::table('srz_cats')->where([
    'type' =>'movies'
    ])->count();?></span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Total Views</span>
                                        <span class="h3 font-bold mb-0"> <?php echo total_views(); ?></span>
                                    </div>
                                    <div class="col-auto">
