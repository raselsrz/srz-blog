        ...
        <div class="card shadow border-0 mb-7 add-container">
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label">Site phone</label>
                        <input type="text" name="phone" value="<?php echo htmlspecialchars(get_option('phone',''));?>" class="form-control" id="phone"  >
                    </div>


                    <div class="mb-3">
                        <label for="email" class="form-label">About Video url</label>
                        <input type="text" name="about_video" value="<?php echo htmlspecialchars(get_option('about_video',''));?>" class="form-control" id="about_video"  >
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="telegram" class="form-label">Pinterest</label>
                        <input type="text" name="pinterest" value="<?php echo htmlspecialchars(get_option('pinterest',''));?>" class="form-control" id="pinterest"  >
                    </div>
