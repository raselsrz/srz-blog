                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumbs-area">
                            <h1>Search Your Result "<?php echo $q; ?>"  </h1>
                            <ul>
                                <li>
                                    <a href="/">Home</a>
                                </li>
        ...
        <section class="blog-wrap-layout22">
            <div class="container">
                <div class="row gutters-50">
                    ...
                    <?php if($total_posts > 0){ ?>
                        ...
                        <div class="pagination-layout1">
                            ...
                            <ul>
                                ...
                                <li class="<?php echo $i == $page?'active':''; ?>"><a href="/search?q=<?php echo $q; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php } ?>
                            </ul>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="breadcrumbs-area">
                            <h1><?php //echo $q; ?>Your Search Not Mechanic </h1>
